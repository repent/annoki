...
class TextsControllerTest < ActionController::TestCase
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post :create, text: { author: @text.author, content: @text.content, date: @text.date, name: @text.name }
    end
  ...
  test "should update text" do
    patch :update, id: @text, text: { author: @text.author, content: @text.content, date: @text.date, name: @text.name }
    assert_redirected_to text_path(assigns(:text))
  end
